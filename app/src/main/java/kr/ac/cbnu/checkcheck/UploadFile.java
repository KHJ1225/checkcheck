    ...
    protected String doInBackground(String... strings){
        if(!sourceFile.isFile()){
            ...
            try{
                ...
                //사용자 이름으로 폴더를 생성하기 위해 사용자 이름을 서버로 전송한다. 하나의 인자 전달 data = newImage
                ...
                //이미지 전송, 데이터 전달 uploadded_file이라는 php key 값에 저장되는 내용은 fileName
                dos.writeBytes(twoHyphens + boundary + lineEnd);
                ...
                // send multipart form data necessary after file data..., 마지막에 two~~ lineEnd로 마무리
                dos.writeBytes(lineEnd);
